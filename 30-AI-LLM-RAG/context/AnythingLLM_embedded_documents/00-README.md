...
Chaque sous-dossier se concentre sur une approche spécifique pilotée par l'IA. Merci de consulter le fichier **README.md** correspondant dans chaque répertoire pour des explications, exemples et workflows détaillés.
